...
function legalPage(kind: 'privacy' | 'terms'): void {
  ...
  const body = privacy ? `
    <p class="lede">Your recordings remain under your control.</p><h2>What stays local</h2><p>Recordings, captions, beat markers, and posters use browser storage. Demo Loop does not upload them.</p><h2>Screen and microphone access</h2><p>The browser asks after you choose to record. Microphone access is optional.</p><h2>Purchases</h2><p>Sociobot and Dodo handle checkout. Demo Loop stores your license token and cached verdict locally. Card fields are not part of this app.</p><h2>Network requests</h2><p>The app contacts the Sociobot API only for checkout and license checks. It has no analytics, ads, or third-party fonts.</p><h2>Your control</h2><p>Export a JSON backup or delete a recording. Clearing this site’s data removes recordings and the saved license.</p>` : `
